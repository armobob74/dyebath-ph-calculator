...
function calculate_mass(target_ph,water_vol){
	...
	let message = `To get a <strong>${water_vol}L</strong> solution with a pH of <strong>${target_ph}</strong>, you need <strong>${mass_required.toFixed(1)}g</strong>  of Soda Ash`;
